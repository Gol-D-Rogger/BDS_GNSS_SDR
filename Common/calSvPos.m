...
switch obs.constellation
    ...
    case 'BEIDOU'
        ...
        elseif isfield(obsHeader.obsType.typeIndexBEIDOU,'C7I') && ~isnan(obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C7I))
            pseudorange = obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C7I);
        elseif isfield(obsHeader.obsType.typeIndexBEIDOU,'C7Q') && ~isnan(obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C7Q))
            pseudorange = obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C7Q);
        elseif isfield(obsHeader.obsType.typeIndexBEIDOU,'C7X') && ~isnan(obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C7X))
            pseudorange = obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C7X);
        elseif isfield(obsHeader.obsType.typeIndexBEIDOU,'C6I') && ~isnan(obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C6I))
            pseudorange = obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C6I);
        elseif isfield(obsHeader.obsType.typeIndexBEIDOU,'C6Q') && ~isnan(obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C6Q))
            pseudorange = obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C6Q);
        elseif isfield(obsHeader.obsType.typeIndexBEIDOU,'C6X') && ~isnan(obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C6X))
            pseudorange = obs.measurements(obsHeader.obsType.typeIndexBEIDOU.C6X);        
        else
            svPos = [];
            return
        end
