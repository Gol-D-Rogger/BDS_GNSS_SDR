...
%     [subframe(16:30),~] = BCH(subframe(16:30)');
    ...
    switch subframeID 
        ...
        case 2  %--- It is subframe 2 -------------------------------------
            ...
            eph.e           = twosComp2dec([subframe(137:146) subframe(151:161) subframe(166:176)]) * 2^(-33);
        ...
        case 4  %--- It is subframe 4 -------------------------------------
            ...
            eph.sqrtA_sub4  = twosComp2dec([subframe(55:56) subframe(61:71) subframe(76:86)]) * 2^(-11);
%           eph.
%         case 5  %--- It is subframe 5 -------------------------------------
%             eph.pnum5=bin2dec(subframe(48:54));
