...
for i_run = 1 : max_runs
    if  mod(i_run, max_runs/resolution) == 1
        ...
        disp(num2str([ebno_vec'  num_bit_err./num_runs/K num_bit_err2./num_runs/K num_pack_err./num_runs num_pack_err_chase./num_runs]));
        disp(' ');
    end
...
%         info_bch_decode2(1:15) = hard_decision(1:15);
%         for jj = 1 :19
%             codeout = step(dec,hard_decision(15*jj+1 : 15*jj+15)');
