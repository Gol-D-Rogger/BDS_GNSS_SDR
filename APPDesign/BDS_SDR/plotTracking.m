...
%% Plot all figures =======================================================
        ...
        handles(2,1).Position = [0.146935819337814 0.437762021950661 0.196469977763635 0.172052986478065];
        handles(2,2).Position = [0.410797101449275 0.389632352941176 0.494202898550725 0.215735294117647];

        handles(3,1).Position = [0.146935819337814 0.111129669009485 0.196469977763635 0.172052986478064];
        handles(3,2).Position = [0.427732920787089 0.111129669009485 0.196469977763635 0.172052986478064];
        handles(3,3).Position = [0.708530022236365 0.111129669009485 0.196469977763635 0.172052986478064];
